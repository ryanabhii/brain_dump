...
class SheetShell extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Use the aspect-specific accessor so only viewInsets changes trigger a
    // rebuild of this widget — not every MediaQuery change.  The broad
    // MediaQuery.of(context) registers SheetShell's element as a dependent
    // of the root MediaQuery InheritedWidget; when the keyboard hides while
    // the sheet is being dismissed Flutter tries to rebuild an element in a
    // route that's already being torn down, causing the
    // '_dependents.isEmpty' and 'dirty widget in wrong build scope' errors.
